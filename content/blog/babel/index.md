...
*env*프리셋을 사용해보자. 구성이 없으면 이 프리셋은 모던 자바스크립트를 지원하기위한 모든 *plugin*을 포함한다.
...
*env*는 `targets`옵션으로 브라우저를 지정할 수 있다.
...
**Babel Loader**는 *Babel*과 *webpack*을 이용하여 *JavaScript*파일을 변환한다.
